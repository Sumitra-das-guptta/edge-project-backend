...
php artisan make:model Student --migration (two in one)
...
then migrate command

php artisan migrate

then create table command
...
add columns
php artisan make::migration add_columns_to_students_table

make seeder
php artisan make:seeder CustomerSeeder

creating helper function
app/helper.php file create

add this file to composer.json file's autoload key value. --> create new variable files that contains array 
of file name.
run command 
composer dump-autoload

### create course one to many relations with applicant table
...
### Update course id of the existing applicants according to their assigned course
php artisan make:migration update_applicants_course_id
DB::statement("
            UPDATE applicants a
